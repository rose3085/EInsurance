                    ...
                    return (
                        <div className="firstComponent" key={index}>
                            ...
                            <div className="policy mt-1">
                                <div className="policyNames font-sans">Policy Name: {responseValue.policyName}</div>
                                    <div className="minCover text-base font-sans text-gray-500">Company Name: {responseValue.companyName} </div>
                                    <div className="minCover text-base font-sans text-gray-500"> Minimum Cover: {responseValue.minCover} </div>
